...
// Función para renderizar tarjetas de películas en el front-end
const renderCards = (data) => {
    ...
    data.forEach((movie) => {
        ...
        // Agregar la tarjeta al contenedor principal de películas
        moviesContainer.appendChild(containerCard);
    });
};

// Exportar la función renderCards para que pueda ser importada en otros archivos
export { renderCards };
